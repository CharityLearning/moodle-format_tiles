...
$plugin->version = 2024022501;        // The current plugin version (Date: YYYYMMDDXX).
...
$plugin->release = "4.1.1.1 BETA";
$plugin->supported = [401, 401]; // Supported Moodle version range.
